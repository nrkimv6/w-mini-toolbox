...
5. Claude Code가 `MANUAL_TASKS.md`를 생성/수정했다면 archive/TODO/DONE 후속 이동 전에 해당 exact path를 `D:\work\project\tools\common\commit.ps1 -Files`로 즉시 커밋하고 commit hash를 사용자에게 보이는 closeout evidence에 남긴다.

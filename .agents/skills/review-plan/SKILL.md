...
- 입력이 `D:\work\project\tools\monitor-page\.agents\skills\review-plan\SKILL.md` 같은 receiver mirror path이면 해당 file read를 우선하고, wtools 원본 skill은 source provenance 또는 downstream read-back 근거로만 비교한다.
